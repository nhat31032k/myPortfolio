...
import CV from "../assets/NguyenHoangQuangNhat_CV.pdf";
...
export default function Hero() {
  ...
  const [code] = useState(`
const profile = {
    fullName: 'Nguyen Hoang Quang Nhat',
    title: 'Frontend Developer | Problem Solver',
    skills: [
        'React', 'NextJS', 'Redux', 'scss',
        'tailwindcss',  'TypeScript','Git' 
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
          ...
          <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 py-12 lg:py-0">
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href={CV}
                  download="NguyenHoangQuangNhat_CV.pdf"
              ...
              <div className="hidden lg:block absolute right-96 top-20 animate-float">
                <div className="px-4 py-2 rounded-lg bg-blue-500/10 backdrop-blur-sm border border-blue-500/20 text-blue-400">
                  <i className="fas fa-code"></i>&nbsp;&nbsp;createTive
                </div>
              </div>
